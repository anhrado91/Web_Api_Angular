(function () {
    ...
    angular.module("clumeo").service("storageService", ser);

    ser.$inject = ["$exceptionHandler", "$window", "appConstants"];

    function ser($exceptionHandler, $window, appConstants) {
        ...
        function removeItem(key) {
            ...
            //update localStorage
            try {
                $window.localStorage.setItem(appConstants.STORAGE_KEY, angular.toJson(items));
            } catch (e) {
        ...
        function loadData() {
            ...
            try {
                if (appConstants.STORAGE_KEY in $window.localStorage) {
                    var data = $window.localStorage.getItem(appConstants.STORAGE_KEY);
                    //$window.localStorage.removeItem( appConstants.STORAGE_KEY );
